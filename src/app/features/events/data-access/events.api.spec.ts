...
describe('EventsApi', () => {
  ...
  it('getEvents() should GET /v1/events', () => {
    const mock: EventSummary[] = [
      { id: 1, title: 'Any event', startsAt: '2025-01-01T12:00:00', capacity: 10, registrationsCount: 0, availableSeats: 10 }
    ];
  ...
  it('register() should POST /v1/events/:id/registrations', () => {
